...
const AnimeDescription = styled(Paragraph)`
  color: #595959;
  font-size: 16px;
  margin-bottom: 32px !important;
...
const ResultScreen = ({ anime, onShare, onRestart }) => {
  return (
    <ResultCard>
      <IconWrapper>
        <CheckCircleOutlined />
      ...
      <ResultTitle level={2}>診断結果</ResultTitle>

      <Text type="secondary" style={{ fontSize: '18px', marginBottom: '24px', display: 'block' }}>
        あなたがイメージしていたアニメは...
      </Text>
      ...
      <AnimeTitle level={3}>{anime.title}</AnimeTitle>
